...
export class CWScriptParser extends Parser {
  ...
  public static readonly QUERY = 12;
  public static readonly MIGRATE = 13;
  public static readonly FOR = 14;
  public static readonly IN = 15;
  public static readonly FROM = 16;
  public static readonly STATE = 17;
  ...
  public get grammarFileName(): string {
    return 'CWScriptParser.g4';
  }

  // @Override
  public get ruleNames(): string[] {
    return CWScriptParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return CWScriptParser._serializedATN;
  }
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (
          ((_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << CWScriptParser.CONTRACT) |
                (1 << CWScriptParser.INTERFACE) |
                (1 << CWScriptParser.IMPORT))) !==
              0) ||
          _la === CWScriptParser.CWSPEC_LINE_COMMENT ||
          _la === CWScriptParser.CWSPEC_BLOCK_COMMENT
        ) {
          {
            {
              this.state = 179;
  ...
  public topLevelStmt(): TopLevelStmtContext {
    let _localctx: TopLevelStmtContext = new TopLevelStmtContext(
      this._ctx,
      this.state
    );
  ...
  public contractDefn(): ContractDefnContext {
    let _localctx: ContractDefnContext = new ContractDefnContext(
      this._ctx,
      this.state
    );
  ...
  public interfaceDefn(): InterfaceDefnContext {
    let _localctx: InterfaceDefnContext = new InterfaceDefnContext(
      this._ctx,
      this.state
    );
  ...
  public importStmt(): ImportStmtContext {
    let _localctx: ImportStmtContext = new ImportStmtContext(
      this._ctx,
      this.state
    );
      ...
      switch (this.interpreter.adaptivePredict(this._input, 10, this._ctx)) {
        case 1:
          ...
          this.enterOuterAlt(_localctx, 1);
          {
            ...
            {
              this.state = 221;
              (_localctx as ImportAllStmtContext)._fileName = this.match(
                CWScriptParser.StringLiteral
              );
            }
          }
          break;
        ...
        case 2:
          ...
          this.enterOuterAlt(_localctx, 2);
          {
            ...
            {
              this.state = 234;
              (_localctx as ImportItemsStmtContext)._fileName = this.match(
                CWScriptParser.StringLiteral
              );
            }
          }
  ...
  public importList(): ImportListContext {
    let _localctx: ImportListContext = new ImportListContext(
      this._ctx,
      this.state
    );
  ...
  public importItem(): ImportItemContext {
    let _localctx: ImportItemContext = new ImportItemContext(
      this._ctx,
      this.state
    );
  ...
  public contractBody(): ContractBodyContext {
    let _localctx: ContractBodyContext = new ContractBodyContext(
      this._ctx,
      this.state
    );
          ...
          ((_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << CWScriptParser.ERROR) |
                (1 << CWScriptParser.EVENT) |
                (1 << CWScriptParser.INSTANTIATE) |
                (1 << CWScriptParser.EXEC) |
                (1 << CWScriptParser.QUERY) |
                (1 << CWScriptParser.MIGRATE) |
                (1 << CWScriptParser.STATE) |
                (1 << CWScriptParser.FN) |
                (1 << CWScriptParser.STRUCT) |
                (1 << CWScriptParser.ENUM) |
                (1 << CWScriptParser.TYPE))) !==
              0) ||
          _la === CWScriptParser.CWSPEC_LINE_COMMENT ||
          _la === CWScriptParser.CWSPEC_BLOCK_COMMENT
        ) {
  ...
  public interfaceBody(): InterfaceBodyContext {
    let _localctx: InterfaceBodyContext = new InterfaceBodyContext(
      this._ctx,
      this.state
    );
  ...
  public contractItem(): ContractItemContext {
    let _localctx: ContractItemContext = new ContractItemContext(
      this._ctx,
      this.state
    );
  ...
  public interfaceItem(): InterfaceItemContext {
    let _localctx: InterfaceItemContext = new InterfaceItemContext(
      this._ctx,
      this.state
    );
  ...
  public errorDefn(): ErrorDefnContext {
    let _localctx: ErrorDefnContext = new ErrorDefnContext(
      this._ctx,
      this.state
    );
  ...
  public errorDefnBlock(): ErrorDefnBlockContext {
    let _localctx: ErrorDefnBlockContext = new ErrorDefnBlockContext(
      this._ctx,
      this.state
    );
    ...
    try {
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          (((_la - 1) & ~0x1f) === 0 &&
            ((1 << (_la - 1)) &
              ((1 << (CWScriptParser.CONTRACT - 1)) |
                (1 << (CWScriptParser.INTERFACE - 1)) |
                (1 << (CWScriptParser.IMPORT - 1)) |
                (1 << (CWScriptParser.IMPLEMENTS - 1)) |
                (1 << (CWScriptParser.EXTENDS - 1)) |
                (1 << (CWScriptParser.ERROR - 1)) |
                (1 << (CWScriptParser.EVENT - 1)) |
                (1 << (CWScriptParser.INSTANTIATE - 1)) |
                (1 << (CWScriptParser.EXEC - 1)) |
                (1 << (CWScriptParser.QUERY - 1)) |
                (1 << (CWScriptParser.MIGRATE - 1)) |
                (1 << (CWScriptParser.FOR - 1)) |
                (1 << (CWScriptParser.IN - 1)) |
                (1 << (CWScriptParser.FROM - 1)) |
                (1 << (CWScriptParser.STATE - 1)) |
                (1 << (CWScriptParser.TIMES - 1)) |
                (1 << (CWScriptParser.IF - 1)) |
                (1 << (CWScriptParser.ELSE - 1)) |
                (1 << (CWScriptParser.AND - 1)) |
                (1 << (CWScriptParser.OR - 1)) |
                (1 << (CWScriptParser.TRUE - 1)) |
                (1 << (CWScriptParser.FALSE - 1)) |
                (1 << (CWScriptParser.FN - 1)) |
                (1 << (CWScriptParser.LET - 1)) |
                (1 << (CWScriptParser.RETURN - 1)) |
                (1 << (CWScriptParser.STRUCT - 1)) |
                (1 << (CWScriptParser.ENUM - 1)) |
                (1 << (CWScriptParser.TYPE - 1)) |
                (1 << (CWScriptParser.EMIT - 1)))) !==
              0) ||
          (((_la - 72) & ~0x1f) === 0 &&
            ((1 << (_la - 72)) &
              ((1 << (CWScriptParser.Ident - 72)) |
                (1 << (CWScriptParser.CWSPEC_LINE_COMMENT - 72)) |
                (1 << (CWScriptParser.CWSPEC_BLOCK_COMMENT - 72)))) !==
              0)
        ) {
          {
            this.state = 308;
  ...
  public errorDefnBlock_item(): ErrorDefnBlock_itemContext {
    let _localctx: ErrorDefnBlock_itemContext = new ErrorDefnBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public eventDefn(): EventDefnContext {
    let _localctx: EventDefnContext = new EventDefnContext(
      this._ctx,
      this.state
    );
  ...
  public eventDefnBlock(): EventDefnBlockContext {
    let _localctx: EventDefnBlockContext = new EventDefnBlockContext(
      this._ctx,
      this.state
    );
  ...
  public eventDefnBlock_item(): EventDefnBlock_itemContext {
    let _localctx: EventDefnBlock_itemContext = new EventDefnBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public stateDefn(): StateDefnContext {
    let _localctx: StateDefnContext = new StateDefnContext(
      this._ctx,
      this.state
    );
  ...
  public stateDefnBlock(): StateDefnBlockContext {
    let _localctx: StateDefnBlockContext = new StateDefnBlockContext(
      this._ctx,
      this.state
    );
  ...
  public stateDefnBlock_item(): StateDefnBlock_itemContext {
    let _localctx: StateDefnBlock_itemContext = new StateDefnBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public mapDefnKeys(): MapDefnKeysContext {
    let _localctx: MapDefnKeysContext = new MapDefnKeysContext(
      this._ctx,
      this.state
    );
  ...
  public mapDefnKey(): MapDefnKeyContext {
    let _localctx: MapDefnKeyContext = new MapDefnKeyContext(
      this._ctx,
      this.state
    );
  ...
  public instantiateDefn(): InstantiateDefnContext {
    let _localctx: InstantiateDefnContext = new InstantiateDefnContext(
      this._ctx,
      this.state
    );
  ...
  public instantiateDecl(): InstantiateDeclContext {
    let _localctx: InstantiateDeclContext = new InstantiateDeclContext(
      this._ctx,
      this.state
    );
  ...
  public execDefnBlock(): ExecDefnBlockContext {
    let _localctx: ExecDefnBlockContext = new ExecDefnBlockContext(
      this._ctx,
      this.state
    );
  ...
  public execDefnBlock_item(): ExecDefnBlock_itemContext {
    let _localctx: ExecDefnBlock_itemContext = new ExecDefnBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public execDeclBlock(): ExecDeclBlockContext {
    let _localctx: ExecDeclBlockContext = new ExecDeclBlockContext(
      this._ctx,
      this.state
    );
  ...
  public execDeclBlock_item(): ExecDeclBlock_itemContext {
    let _localctx: ExecDeclBlock_itemContext = new ExecDeclBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public queryDefn(): QueryDefnContext {
    let _localctx: QueryDefnContext = new QueryDefnContext(
      this._ctx,
      this.state
    );
  ...
  public queryDefnBlock(): QueryDefnBlockContext {
    let _localctx: QueryDefnBlockContext = new QueryDefnBlockContext(
      this._ctx,
      this.state
    );
  ...
  public queryDefnBlock_item(): QueryDefnBlock_itemContext {
    let _localctx: QueryDefnBlock_itemContext = new QueryDefnBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public queryDecl(): QueryDeclContext {
    let _localctx: QueryDeclContext = new QueryDeclContext(
      this._ctx,
      this.state
    );
  ...
  public queryDeclBlock(): QueryDeclBlockContext {
    let _localctx: QueryDeclBlockContext = new QueryDeclBlockContext(
      this._ctx,
      this.state
    );
  ...
  public queryDeclBlock_item(): QueryDeclBlock_itemContext {
    let _localctx: QueryDeclBlock_itemContext = new QueryDeclBlock_itemContext(
      this._ctx,
      this.state
    );
  ...
  public migrateDefn(): MigrateDefnContext {
    let _localctx: MigrateDefnContext = new MigrateDefnContext(
      this._ctx,
      this.state
    );
  ...
  public migrateDecl(): MigrateDeclContext {
    let _localctx: MigrateDeclContext = new MigrateDeclContext(
      this._ctx,
      this.state
    );
  ...
  public enumVariant(): EnumVariantContext {
    let _localctx: EnumVariantContext = new EnumVariantContext(
      this._ctx,
      this.state
    );
  ...
  public enumVariant_struct(): EnumVariant_structContext {
    let _localctx: EnumVariant_structContext = new EnumVariant_structContext(
      this._ctx,
      this.state
    );
  ...
  public enumVariant_tuple(): EnumVariant_tupleContext {
    let _localctx: EnumVariant_tupleContext = new EnumVariant_tupleContext(
      this._ctx,
      this.state
    );
  ...
  public tupleMembers(): TupleMembersContext {
    let _localctx: TupleMembersContext = new TupleMembersContext(
      this._ctx,
      this.state
    );
  ...
  public parenStructMembers(): ParenStructMembersContext {
    let _localctx: ParenStructMembersContext = new ParenStructMembersContext(
      this._ctx,
      this.state
    );
  ...
  public curlyStructMembers(): CurlyStructMembersContext {
    let _localctx: CurlyStructMembersContext = new CurlyStructMembersContext(
      this._ctx,
      this.state
    );
  ...
  public structMember(): StructMemberContext {
    let _localctx: StructMemberContext = new StructMemberContext(
      this._ctx,
      this.state
    );
  ...
  public typeExpr(_p?: number): TypeExprContext {
    ...
    let _localctx: TypeExprContext = new TypeExprContext(
      this._ctx,
      _parentState
    );
          ...
          case 2:
            {
              ...
              {
                this.state = 607;
                (_localctx as TupleTypeExprContext)._typeExpr = this.typeExpr(
                  0
                );
                (_localctx as TupleTypeExprContext)._members.push(
                  (_localctx as TupleTypeExprContext)._typeExpr
                );
              }
              this.state = 612;
              this._errHandler.sync(this);
          ...
          if (_alt === 1) {
            ...
            _prevctx = _localctx;
            {
              ...
              switch (
                ...
                case 1:
                  {
                    _localctx = new ParamzdTypeExprContext(
                      new TypeExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                      _startState,
                      CWScriptParser.RULE_typeExpr
                    );
                    this.state = 622;
                ...
                case 2:
                  {
                    _localctx = new ShortOptionTypeExprContext(
                      new TypeExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 3:
                  {
                    _localctx = new ShortVecTypeExprContext(
                      new TypeExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
  ...
  public typeParam(): TypeParamContext {
    let _localctx: TypeParamContext = new TypeParamContext(
      this._ctx,
      this.state
    );
  ...
  public structDefn(): StructDefnContext {
    let _localctx: StructDefnContext = new StructDefnContext(
      this._ctx,
      this.state
    );
  ...
  public enumVariantList(): EnumVariantListContext {
    let _localctx: EnumVariantListContext = new EnumVariantListContext(
      this._ctx,
      this.state
    );
  ...
  public typeAliasDefn(): TypeAliasDefnContext {
    let _localctx: TypeAliasDefnContext = new TypeAliasDefnContext(
      this._ctx,
      this.state
    );
  ...
  public namedFnDecl(): NamedFnDeclContext {
    let _localctx: NamedFnDeclContext = new NamedFnDeclContext(
      this._ctx,
      this.state
    );
  ...
  public namedFnDefn(): NamedFnDefnContext {
    let _localctx: NamedFnDefnContext = new NamedFnDefnContext(
      this._ctx,
      this.state
    );
  ...
  public fnArgList(): FnArgListContext {
    let _localctx: FnArgListContext = new FnArgListContext(
      this._ctx,
      this.state
    );
          ...
          {
            {
              ...
              while (
                ((_la & ~0x1f) === 0 &&
                  ((1 << _la) &
                    ((1 << CWScriptParser.CONTRACT) |
                      ...
                      (1 << CWScriptParser.QUERY) |
                      (1 << CWScriptParser.MIGRATE) |
                      (1 << CWScriptParser.FOR) |
                      (1 << CWScriptParser.IN) |
                      (1 << CWScriptParser.FROM) |
                      (1 << CWScriptParser.STATE) |
                      (1 << CWScriptParser.TIMES) |
                      (1 << CWScriptParser.IF) |
                      (1 << CWScriptParser.ELSE) |
                      (1 << CWScriptParser.AND) |
                      (1 << CWScriptParser.OR) |
                      (1 << CWScriptParser.TRUE) |
                      (1 << CWScriptParser.FALSE) |
                      (1 << CWScriptParser.FN) |
                      (1 << CWScriptParser.LET) |
                      (1 << CWScriptParser.FAIL) |
                      (1 << CWScriptParser.RETURN) |
                      (1 << CWScriptParser.STRUCT) |
                      (1 << CWScriptParser.ENUM) |
                      (1 << CWScriptParser.TYPE))) !==
                    0) ||
                (((_la - 32) & ~0x1f) === 0 &&
                  ((1 << (_la - 32)) &
                    ((1 << (CWScriptParser.EMIT - 32)) |
                      (1 << (CWScriptParser.LPAREN - 32)) |
                      (1 << (CWScriptParser.LBRACK - 32)) |
                      (1 << (CWScriptParser.EXCLAM - 32)) |
                      (1 << (CWScriptParser.D_COLON - 32)) |
                      (1 << (CWScriptParser.PLUS - 32)) |
                      (1 << (CWScriptParser.MINUS - 32)))) !==
                    0) ||
                (((_la - 72) & ~0x1f) === 0 &&
                  ((1 << (_la - 72)) &
                    ((1 << (CWScriptParser.Ident - 72)) |
                      (1 << (CWScriptParser.StringLiteral - 72)) |
                      (1 << (CWScriptParser.IntegerLiteral - 72)) |
                      (1 << (CWScriptParser.DecimalLiteral - 72)))) !==
                    0)
              ) {
                {
                  {
  ...
  public assignStmt_(): AssignStmt_Context {
    let _localctx: AssignStmt_Context = new AssignStmt_Context(
      this._ctx,
      this.state
    );
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            ((_la - 54) & ~0x1f) === 0 &&
            ((1 << (_la - 54)) &
              ((1 << (CWScriptParser.EQ - 54)) |
                (1 << (CWScriptParser.PLUS_EQ - 54)) |
                (1 << (CWScriptParser.MINUS_EQ - 54)) |
                (1 << (CWScriptParser.MUL_EQ - 54)) |
                (1 << (CWScriptParser.DIV_EQ - 54)) |
                (1 << (CWScriptParser.MOD_EQ - 54)))) !==
              0
          )
        ) {
  ...
  public assignLHS(): AssignLHSContext {
    let _localctx: AssignLHSContext = new AssignLHSContext(
      this._ctx,
      this.state
    );
        ...
        case 2:
          ...
          this.enterOuterAlt(_localctx, 2);
          {
            ...
            this.match(CWScriptParser.LBRACK);
            {
              ...
              (_localctx as StateMapAssignLHSContext)._mapKeys.push(
                (_localctx as StateMapAssignLHSContext)._expr
              );
            }
            this.state = 805;
            this._errHandler.sync(this);
  ...
  public innerAssign(): InnerAssignContext {
    let _localctx: InnerAssignContext = new InnerAssignContext(
      this._ctx,
      this.state
    );
  ...
  public innerPath(): InnerPathContext {
    let _localctx: InnerPathContext = new InnerPathContext(
      this._ctx,
      this.state
    );
          ...
          case 3:
            {
              ...
              this.match(CWScriptParser.LBRACK);
              {
                ...
                (_localctx as StateMapAccessExprContext)._mapKeys.push(
                  (_localctx as StateMapAccessExprContext)._expr
                );
              }
              this.state = 857;
              this._errHandler.sync(this);
                ...
                {
                  {
                    ...
                    this.match(CWScriptParser.COMMA);
                    this.state = 854;
                    (_localctx as StateMapAccessExprContext)._expr = this.expr(
                      0
                    );
                    (_localctx as StateMapAccessExprContext)._mapKeys.push(
                      (_localctx as StateMapAccessExprContext)._expr
          ...
          case 4:
            {
              ...
              if (
                !(
                  ((_la - 43) & ~0x1f) === 0 &&
                  ((1 << (_la - 43)) &
                    ((1 << (CWScriptParser.EXCLAM - 43)) |
                      (1 << (CWScriptParser.PLUS - 43)) |
                      (1 << (CWScriptParser.MINUS - 43)))) !==
                    0
                )
              ) {
        ...
        while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
          if (_alt === 1) {
            ...
            _prevctx = _localctx;
            {
              ...
              this._errHandler.sync(this);
              switch (
                this.interpreter.adaptivePredict(this._input, 104, this._ctx)
              ) {
                case 1:
                  {
                    _localctx = new ExpExprContext(
                      new ExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                      _startState,
                      CWScriptParser.RULE_expr
                    );
                    this.state = 870;
                ...
                case 2:
                  {
                    _localctx = new MultDivModExprContext(
                      new ExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                    ...
                    this.state = 874;
                    (_localctx as MultDivModExprContext)._op = this._input.LT(
                      1
                    );
                    _la = this._input.LA(1);
                    if (
                      !(
                        ((_la - 61) & ~0x1f) === 0 &&
                        ((1 << (_la - 61)) &
                          ((1 << (CWScriptParser.MUL - 61)) |
                            (1 << (CWScriptParser.DIV - 61)) |
                            (1 << (CWScriptParser.MOD - 61)))) !==
                          0
                      )
                    ) {
                      (_localctx as MultDivModExprContext)._op = this._errHandler.recoverInline(
                        this
                      );
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                ...
                case 3:
                  {
                    ...
                    if (
                      !(
                        _la === CWScriptParser.PLUS ||
                        _la === CWScriptParser.MINUS
                      )
                    ) {
                      (_localctx as AddSubExprContext)._op = this._errHandler.recoverInline(
                        this
                      );
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                ...
                case 4:
                  {
                    ...
                    if (
                      !(
                        ((_la - 67) & ~0x1f) === 0 &&
                        ((1 << (_la - 67)) &
                          ((1 << (CWScriptParser.LT - 67)) |
                            (1 << (CWScriptParser.LT_EQ - 67)) |
                            (1 << (CWScriptParser.GT - 67)) |
                            (1 << (CWScriptParser.GT_EQ - 67)))) !==
                          0
                      )
                    ) {
                      (_localctx as CompExprContext)._op = this._errHandler.recoverInline(
                        this
                      );
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                ...
                case 5:
                  {
                    ...
                    if (
                      !(
                        _la === CWScriptParser.EQEQ ||
                        _la === CWScriptParser.NEQ
                      )
                    ) {
                      (_localctx as EqExprContext)._op = this._errHandler.recoverInline(
                        this
                      );
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                ...
                case 9:
                  {
                    _localctx = new TableLookupExprContext(
                      new ExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 10:
                  {
                    _localctx = new PosArgsFnCallExprContext(
                      new ExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 11:
                  {
                    _localctx = new NamedArgsFnCallExprContext(
                      new ExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
  ...
  public structVal_(): StructVal_Context {
    let _localctx: StructVal_Context = new StructVal_Context(
      this._ctx,
      this.state
    );
  ...
  public structValMembers(): StructValMembersContext {
    let _localctx: StructValMembersContext = new StructValMembersContext(
      this._ctx,
      this.state
    );
  ...
  public structValMember(): StructValMemberContext {
    let _localctx: StructValMemberContext = new StructValMemberContext(
      this._ctx,
      this.state
    );
  ...
  public ifClause_(): IfClause_Context {
    let _localctx: IfClause_Context = new IfClause_Context(
      this._ctx,
      this.state
    );
  ...
  public elseIfClauses(): ElseIfClausesContext {
    let _localctx: ElseIfClausesContext = new ElseIfClausesContext(
      this._ctx,
      this.state
    );
  ...
  public elseClause(): ElseClauseContext {
    let _localctx: ElseClauseContext = new ElseClauseContext(
      this._ctx,
      this.state
    );
  ...
  public identList(): IdentListContext {
    let _localctx: IdentListContext = new IdentListContext(
      this._ctx,
      this.state
    );
  ...
  public namedExprList(): NamedExprListContext {
    let _localctx: NamedExprListContext = new NamedExprListContext(
      this._ctx,
      this.state
    );
  ...
  public namedExpr(): NamedExprContext {
    let _localctx: NamedExprContext = new NamedExprContext(
      this._ctx,
      this.state
    );
  ...
  public reservedKeyword(): ReservedKeywordContext {
    let _localctx: ReservedKeywordContext = new ReservedKeywordContext(
      this._ctx,
      this.state
    );
  ...
  private static readonly _serializedATNSegment0: string =
    ...
    '\x0E\x02\xBA\v\x02\x03\x02\x03\x02\x03\x03\x03\x03\x03\x03\x05\x03\xC1' +
    '\n\x03\x03\x04\x05\x04\xC4\n\x04\x03\x04\x03\x04\x03\x04\x03\x04\x05\x04' +
    '\xCA\n\x04\x03\x04\x03\x04\x05\x04\xCE\n\x04\x03\x04\x03\x04\x03\x05\x05' +
    ...
    '\f\x07\x0E\x07\xF7\v\x07\x03\b\x03\b\x03\b\x05\b\xFC\n\b\x03\t\x03\t\x07' +
    '\t\u0100\n\t\f\t\x0E\t\u0103\v\t\x03\t\x03\t\x03\n\x03\n\x07\n\u0109\n' +
    '\n\f\n\x0E\n\u010C\v\n\x03\n\x03\n\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v' +
    '\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x05\v\u011E\n\v\x03\f' +
    '\x03\f\x03\f\x03\f\x03\f\x03\f\x03\f\x03\f\x03\f\x03\f\x03\f\x03\f\x03' +
    '\f\x05\f\u012D\n\f\x03\r\x05\r\u0130\n\r\x03\r\x03\r\x03\r\x03\x0E\x03' +
    '\x0E\x03\x0E\x03\x0E\x03\x0E\x07\x0E\u013A\n\x0E\f\x0E\x0E\x0E\u013D\v' +
    '\x0E\x03\x0E\x05\x0E\u0140\n\x0E\x05\x0E\u0142\n\x0E\x03\x0E\x03\x0E\x03' +
    '\x0F\x05\x0F\u0147\n\x0F\x03\x0F\x03\x0F\x03\x10\x05\x10\u014C\n\x10\x03' +
    '\x10\x03\x10\x03\x10\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x07\x11\u0156' +
    '\n\x11\f\x11\x0E\x11\u0159\v\x11\x03\x11\x05\x11\u015C\n\x11\x05\x11\u015E' +
    '\n\x11\x03\x11\x03\x11\x03\x12\x05\x12\u0163\n\x12\x03\x12\x03\x12\x03' +
    ...
    '\x15\x03\x15\x05\x15\u0189\n\x15\x03\x15\x05\x15\u018C\n\x15\x03\x16\x03' +
    '\x16\x03\x16\x03\x16\x03\x17\x03\x17\x03\x17\x03\x17\x03\x17\x03\x18\x03' +
    '\x18\x03\x18\x03\x18\x07\x18\u019B\n\x18\f\x18\x0E\x18\u019E\v\x18\x03' +
    '\x18\x03\x18\x03\x19\x03\x19\x03\x19\x05\x19\u01A5\n\x19\x03\x19\x03\x19' +
    '\x03\x1A\x05\x1A\u01AA\n\x1A\x03\x1A\x03\x1A\x03\x1A\x05\x1A\u01AF\n\x1A' +
    '\x03\x1A\x03\x1A\x03\x1B\x05\x1B\u01B4\n\x1B\x03\x1B\x03\x1B\x03\x1B\x05' +
    '\x1B\u01B9\n\x1B\x03\x1C\x05\x1C\u01BC\n\x1C\x03\x1C\x03\x1C\x03\x1C\x03' +
    '\x1D\x03\x1D\x03\x1D\x07\x1D\u01C4\n\x1D\f\x1D\x0E\x1D\u01C7\v\x1D\x03' +
    '\x1D\x03\x1D\x03\x1E\x05\x1E\u01CC\n\x1E\x03\x1E\x03\x1E\x03\x1F\x05\x1F' +
    '\u01D1\n\x1F\x03\x1F\x03\x1F\x03\x1F\x03 \x03 \x03 \x07 \u01D9\n \f \x0E' +
    ' \u01DC\v \x03 \x03 \x03!\x05!\u01E1\n!\x03!\x03!\x03"\x05"\u01E6\n' +
    ...
    '\n/\f/\x0E/\u024C\v/\x03/\x05/\u024F\n/\x05/\u0251\n/\x03/\x03/\x030\x05' +
    '0\u0256\n0\x030\x030\x050\u025A\n0\x030\x030\x030\x031\x031\x031\x031' +
    '\x031\x031\x071\u0265\n1\f1\x0E1\u0268\v1\x031\x031\x031\x031\x031\x05' +
    '1\u026F\n1\x031\x031\x031\x031\x031\x031\x031\x071\u0278\n1\f1\x0E1\u027B' +
    '\v1\x032\x032\x032\x032\x072\u0281\n2\f2\x0E2\u0284\v2\x032\x032\x033' +
    ...
    'B\x03B\x03B\x03B\x03B\x03B\x03B\x03B\x03B\x03B\x03B\x03B\x03B\x05B\u0303' +
    '\nB\x03C\x03C\x03C\x03C\x03C\x03D\x03D\x03D\x05D\u030D\nD\x03D\x03D\x03' +
    'D\x03D\x05D\u0313\nD\x03E\x03E\x03E\x03E\x03F\x03F\x03F\x03F\x05F\u031D' +
    '\nF\x03F\x03F\x03F\x03F\x03F\x03F\x03F\x07F\u0326\nF\fF\x0EF\u0329\vF' +
    '\x03F\x03F\x05F\u032D\nF\x03F\x03F\x03F\x03F\x03F\x03F\x03F\x03F\x03F' +
    '\x03F\x05F\u0339\nF\x03G\x03G\x03G\x03G\x07G\u033F\nG\fG\x0EG\u0342\v' +
    'G\x03H\x03H\x03H\x03H\x03H\x05H\u0349\nH\x03I\x03I\x03I\x03I\x03I\x03' +
    'I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x07I\u035A\nI\fI\x0EI\u035D' +
    '\vI\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x05I\u0367\nI\x03I\x03I\x03' +
    'I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03' +
    'I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03I\x03' +
    'I\x03I\x03I\x05I\u038A\nI\x03I\x03I\x03I\x03I\x05I\u0390\nI\x03I\x07I' +
    '\u0393\nI\fI\x0EI\u0396\vI\x03J\x03J\x03J\x03J\x03J\x03J\x03J\x03J\x03' +
    'J\x03J\x03J\x03J\x03J\x03J\x03J\x03J\x03J\x03J\x05J\u03AA\nJ\x03K\x03' +
    'K\x03K\x05K\u03AF\nK\x03K\x03K\x03L\x03L\x03L\x07L\u03B6\nL\fL\x0EL\u03B9' +
    '\vL\x03L\x05L\u03BC\nL\x03M\x03M\x03M\x03M\x03N\x03N\x05N\u03C4\nN\x03' +
    'N\x05N\u03C7\nN\x03O\x03O\x03O\x03O\x03O\x03O\x03O\x03O\x05O\u03D1\nO' +
    '\x03P\x03P\x06P\u03D5\nP\rP\x0EP\u03D6\x03Q\x03Q\x03Q\x03R\x03R\x03R\x03' +
    'R\x03R\x03R\x03R\x03R\x03R\x03R\x03R\x05R\u03E7\nR\x03S\x03S\x03S\x07' +
    'S\u03EC\nS\fS\x0ES\u03EF\vS\x03T\x03T\x03T\x07T\u03F4\nT\fT\x0ET\u03F7' +
    '\vT\x03U\x03U\x03U\x07U\u03FC\nU\fU\x0EU\u03FF\vU\x03V\x03V\x03V\x03V' +
    '\x03W\x03W\x05W\u0407\nW\x03X\x06X\u040A\nX\rX\x0EX\u040B\x03Y\x03Y\x03' +
    'Y\x02\x02\x04`\x90Z\x02\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E\x02' +
    ...
    '\x02\xB0\x02\x02\n\b\x0288<<>>@@BBDD\x05\x02--;;==\x05\x02??AACC\x04\x02' +
    ';;==\x03\x02EH\x03\x029:\x03\x02NO\x05\x02\x03\x06\t\x1C\x1E"\x02\u046B' +
    '\x02\xB3\x03\x02\x02\x02\x04\xC0\x03\x02\x02\x02\x06\xC3\x03\x02\x02\x02' +
    '\b\xD2\x03\x02\x02\x02\n\xEE\x03\x02\x02\x02\f\xF0\x03\x02\x02\x02\x0E' +
    '\xF8\x03\x02\x02\x02\x10\xFD\x03\x02\x02\x02\x12\u0106\x03\x02\x02\x02' +
    '\x14\u011D\x03\x02\x02\x02\x16\u012C\x03\x02\x02\x02\x18\u012F\x03\x02' +
    '\x02\x02\x1A\u0134\x03\x02\x02\x02\x1C\u0146\x03\x02\x02\x02\x1E\u014B' +
    '\x03\x02\x02\x02 \u0150\x03\x02\x02\x02"\u0162\x03\x02\x02\x02$\u0170' +
    '\x03\x02\x02\x02&\u0172\x03\x02\x02\x02(\u018B\x03\x02\x02\x02*\u018D' +
    '\x03\x02\x02\x02,\u0191\x03\x02\x02\x02.\u0196\x03\x02\x02\x020\u01A4' +
    '\x03\x02\x02\x022\u01A9\x03\x02\x02\x024\u01B3\x03\x02\x02\x026\u01BB' +
    '\x03\x02\x02\x028\u01C0\x03\x02\x02\x02:\u01CB\x03\x02\x02\x02<\u01D0' +
    '\x03\x02\x02\x02>\u01D5\x03\x02\x02\x02@\u01E0\x03\x02\x02\x02B\u01E5' +
    '\x03\x02\x02\x02D\u01EA\x03\x02\x02\x02F\u01F5\x03\x02\x02\x02H\u01FA' +
    '\x03\x02\x02\x02J\u01FF\x03\x02\x02\x02L\u020A\x03\x02\x02\x02N\u020F' +
    '\x03\x02\x02\x02P\u0219\x03\x02\x02\x02R\u0222\x03\x02\x02\x02T\u0224' +
    '\x03\x02\x02\x02V\u0229\x03\x02\x02\x02X\u022C\x03\x02\x02\x02Z\u0237' +
    '\x07\u037D\u037E\f\x11\x02\x02\u037E\u037F\x07*\x02\x02\u037F\u0393\x05' +
    '\xACW\x02\u0380\u0381\f\x10\x02\x02\u0381\u0382\x07&\x02\x02\u0382\u0383' +
    "\x05\x90I\x02\u0383\u0384\x07+\x02\x02\u0384\u0385\x07'\x02\x02\u0385" +
    '\u0393\x03\x02\x02\x02\u0386\u0387\f\x0F\x02\x02\u0387\u0389\x07$\x02' +
    '\x02\u0388\u038A\x05\xA6T\x02\u0389\u0388\x03\x02\x02\x02\u0389\u038A' +
    '\x03\x02\x02\x02\u038A\u038B\x03\x02\x02\x02\u038B\u0393\x07%\x02\x02' +
    '\u038C\u038D\f\x0E\x02\x02\u038D\u038F\x07$\x02\x02\u038E\u0390\x05\xA8' +
    'U\x02\u038F\u038E\x03\x02\x02\x02\u038F\u0390\x03\x02\x02\x02\u0390\u0391' +
    '\x03\x02\x02\x02\u0391\u0393\x07%\x02\x02\u0392\u0368\x03\x02\x02\x02' +
    '\u0392\u036B\x03\x02\x02\x02\u0392\u036E\x03\x02\x02\x02\u0392\u0371\x03' +
    '\x02\x02\x02\u0392\u0374\x03\x02\x02\x02\u0392\u0377\x03\x02\x02\x02\u0392' +
    '\u037A\x03\x02\x02\x02\u0392\u037D\x03\x02\x02\x02\u0392\u0380\x03\x02' +
    '\x02\x02\u0392\u0386\x03\x02\x02\x02\u0392\u038C\x03\x02\x02\x02\u0393' +
    '\u0396\x03\x02\x02\x02\u0394\u0392\x03\x02\x02\x02\u0394\u0395\x03\x02' +
    '\x02\x02\u0395\x91\x03\x02\x02\x02\u0396\u0394\x03\x02\x02\x02\u0397\u0398' +
    '\x07$\x02\x02\u0398\u03AA\x07%\x02\x02\u0399\u03AA\x05\x94K\x02\u039A' +
    '\u039B\x05f4\x02\u039B\u039C\x07$\x02\x02\u039C\u039D\x05\xA6T\x02\u039D' +
    '\u039E\x07%\x02\x02\u039E\u03AA\x03\x02\x02\x02\u039F\u03A0\x07&\x02\x02' +
    "\u03A0\u03A1\x05\xA6T\x02\u03A1\u03A2\x07'\x02\x02\u03A2\u03AA\x03\x02" +
    '\x02\x02\u03A3\u03AA\x07K\x02\x02\u03A4\u03AA\x07L\x02\x02\u03A5\u03AA' +
    '\x07M\x02\x02\u03A6\u03AA\x07\x19\x02\x02\u03A7\u03AA\x07\x1A\x02\x02' +
    '\u03A8\u03AA\x05\xACW\x02\u03A9\u0397\x03\x02\x02\x02\u03A9\u0399\x03' +
    '\x02\x02\x02\u03A9\u039A\x03\x02\x02\x02\u03A9\u039F\x03\x02\x02\x02\u03A9' +
    '\u03A3\x03\x02\x02\x02\u03A9\u03A4\x03\x02\x02\x02\u03A9\u03A5\x03\x02' +
    '\x02\x02\u03A9\u03A6\x03\x02\x02\x02\u03A9\u03A7\x03\x02\x02\x02\u03A9' +
    '\u03A8\x03\x02\x02\x02\u03AA\x93\x03\x02\x02\x02\u03AB\u03AC\x05f4\x02' +
    '\u03AC\u03AE\x07(\x02\x02\u03AD\u03AF\x05\x96L\x02\u03AE\u03AD\x03\x02' +
    '\x02\x02\u03AE\u03AF\x03\x02\x02\x02\u03AF\u03B0\x03\x02\x02\x02\u03B0' +
    '\u03B1\x07)\x02\x02\u03B1\x95\x03\x02\x02\x02\u03B2\u03B7\x05\x98M\x02' +
    '\u03B3\u03B4\x07+\x02\x02\u03B4\u03B6\x05\x98M\x02\u03B5\u03B3\x03\x02' +
    ...
    '\x03\x02\x02\x02\u03BC\x97\x03\x02\x02\x02\u03BD\u03BE\x05\xACW\x02\u03BE' +
    '\u03BF\x07.\x02\x02\u03BF\u03C0\x05\x90I\x02\u03C0\x99\x03\x02\x02\x02' +
    '\u03C1\u03C3\x05\x9CO\x02\u03C2\u03C4\x05\x9EP\x02\u03C3\u03C2\x03\x02' +
    '\x02\x02\u03C3\u03C4\x03\x02\x02\x02\u03C4\u03C6\x03\x02\x02\x02\u03C5' +
    '\u03C7\x05\xA0Q\x02\u03C6\u03C5\x03\x02\x02\x02\u03C6\u03C7\x03\x02\x02' +
    '\x02\u03C7\x9B\x03\x02\x02\x02\u03C8\u03C9\x07\x15\x02\x02\u03C9\u03CA' +
    '\x05\x90I\x02\u03CA\u03CB\x05\x80A\x02\u03CB\u03D1\x03\x02\x02\x02\u03CC' +
    '\u03CD\x07\x15\x02\x02\u03CD\u03CE\x05\x84C\x02\u03CE\u03CF\x05\x80A\x02' +
    '\u03CF\u03D1\x03\x02\x02\x02\u03D0\u03C8\x03\x02\x02\x02\u03D0\u03CC\x03' +
    '\x02\x02\x02\u03D1\x9D\x03\x02\x02\x02\u03D2\u03D3\x07\x16\x02\x02\u03D3' +
    '\u03D5\x05\x9CO\x02\u03D4\u03D2\x03\x02\x02\x02\u03D5\u03D6\x03\x02\x02' +
    '\x02\u03D6\u03D4\x03\x02\x02\x02\u03D6\u03D7\x03\x02\x02\x02\u03D7\x9F' +
    '\x03\x02\x02\x02\u03D8\u03D9\x07\x16\x02\x02\u03D9\u03DA\x05\x80A\x02' +
    '\u03DA\xA1\x03\x02\x02\x02\u03DB\u03DC\x07\x10\x02\x02\u03DC\u03DD\x05' +
    '\x86D\x02\u03DD\u03DE\x07\x11\x02\x02\u03DE\u03DF\x05\x90I\x02\u03DF\u03E0' +
    '\x05\x80A\x02\u03E0\u03E7\x03\x02\x02\x02\u03E1\u03E2\x07\x10\x02\x02' +
    '\u03E2\u03E3\x05\x90I\x02\u03E3\u03E4\x07\x14\x02\x02\u03E4\u03E5\x05' +
    '\x80A\x02\u03E5\u03E7\x03\x02\x02\x02\u03E6\u03DB\x03\x02\x02\x02\u03E6' +
    '\u03E1\x03\x02\x02\x02\u03E7\xA3\x03\x02\x02\x02\u03E8\u03ED\x05\xACW' +
    '\x02\u03E9\u03EA\x07+\x02\x02\u03EA\u03EC\x05\xACW\x02\u03EB\u03E9\x03' +
    '\x02\x02\x02\u03EC\u03EF\x03\x02\x02\x02\u03ED\u03EB\x03\x02\x02\x02\u03ED' +
    '\u03EE\x03\x02\x02\x02\u03EE\xA5\x03\x02\x02\x02\u03EF\u03ED\x03\x02\x02' +
    '\x02\u03F0\u03F5\x05\x90I\x02\u03F1\u03F2\x07+\x02\x02\u03F2\u03F4\x05' +
    '\x90I\x02\u03F3\u03F1\x03\x02\x02\x02\u03F4\u03F7\x03\x02\x02\x02\u03F5' +
    '\u03F3\x03\x02\x02\x02\u03F5\u03F6\x03\x02\x02\x02\u03F6\xA7\x03\x02\x02' +
    '\x02\u03F7\u03F5\x03\x02\x02\x02\u03F8\u03FD\x05\xAAV\x02\u03F9\u03FA' +
    '\x07+\x02\x02\u03FA\u03FC\x05\xAAV\x02\u03FB\u03F9\x03\x02\x02\x02\u03FC' +
    '\u03FF\x03\x02\x02\x02\u03FD\u03FB\x03\x02\x02\x02\u03FD\u03FE\x03\x02' +
    '\x02\x02\u03FE\xA9\x03\x02\x02\x02\u03FF\u03FD\x03\x02\x02\x02\u0400\u0401' +
    '\x05\xACW\x02\u0401\u0402\x07.\x02\x02\u0402\u0403\x05\x90I\x02\u0403' +
    '\xAB\x03\x02\x02\x02\u0404\u0407\x07J\x02\x02\u0405\u0407\x05\xB0Y\x02' +
    '\u0406\u0404\x03\x02\x02\x02\u0406\u0405\x03\x02\x02\x02\u0407\xAD\x03' +
    '\x02\x02\x02\u0408\u040A\t\b\x02\x02\u0409\u0408\x03\x02\x02\x02\u040A' +
    '\u040B\x03\x02\x02\x02\u040B\u0409\x03\x02\x02\x02\u040B\u040C\x03\x02' +
    '\x02\x02\u040C\xAF\x03\x02\x02\x02\u040D\u040E\t\t\x02\x02\u040E\xB1\x03' +
    '\x02\x02\x02z\xB3\xB8\xC0\xC3\xC9\xCD\xD2\xD8\xE4\xE9\xEE\xF5\xFB\u0101' +
    '\u010A\u011D\u012C\u012F\u013B\u013F\u0141\u0146\u014B\u0157\u015B\u015D' +
    '\u0162\u0167\u016C\u0170\u0179\u017D\u017F\u0184\u0188\u018B\u019C\u01A4' +
    '\u01A9\u01AE\u01B3\u01B8\u01BB\u01C5\u01CB\u01D0\u01DA\u01E0\u01E5\u01EF' +
    '\u01F5\u01FA\u0204\u020A\u020F\u0214\u0219\u021E\u0222\u0227\u0232\u023D' +
  ...
  public static get _ATN(): ATN {
    if (!CWScriptParser.__ATN) {
      CWScriptParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(CWScriptParser._serializedATN)
      );
    }
...
export class ContractDefnContext extends ParserRuleContext {
  ...
  public EXTENDS(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EXTENDS, 0);
  }
  public IMPLEMENTS(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.IMPLEMENTS, 0);
  }
  public cwspec(): CwspecContext | undefined {
    return this.tryGetRuleContext(0, CwspecContext);
  }
...
export class ImportAllStmtContext extends ImportStmtContext {
  ...
  public StringLiteral(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.StringLiteral, 0);
  }
...
export class ImportItemsStmtContext extends ImportStmtContext {
  ...
  public LPAREN(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.LPAREN, 0);
  }
  public RPAREN(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.RPAREN, 0);
  }
  ...
  public COMMA(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.COMMA, 0);
  }
  constructor(ctx: ImportStmtContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ImportListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return CWScriptParser.RULE_importList;
  }
  // @Override
  public enterRule(listener: CWScriptParserListener): void {
...
export class ImportItemContext extends ParserRuleContext {
  ...
  public AS(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.AS, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return CWScriptParser.RULE_importItem;
  }
  // @Override
  public enterRule(listener: CWScriptParserListener): void {
...
export class InterfaceBodyContext extends ParserRuleContext {
  ...
  public interfaceItem(
    i?: number
  ): InterfaceItemContext | InterfaceItemContext[] {
    if (i === undefined) {
...
export class ErrorDefnBlockContext extends ParserRuleContext {
  ...
  public errorDefnBlock_item(
    i?: number
  ): ErrorDefnBlock_itemContext | ErrorDefnBlock_itemContext[] {
    if (i === undefined) {
...
export class EventDefnBlockContext extends ParserRuleContext {
  ...
  public eventDefnBlock_item(
    i?: number
  ): EventDefnBlock_itemContext | EventDefnBlock_itemContext[] {
    if (i === undefined) {
...
export class StateDefnBlockContext extends ParserRuleContext {
  ...
  public stateDefnBlock_item(
    i?: number
  ): StateDefnBlock_itemContext | StateDefnBlock_itemContext[] {
    if (i === undefined) {
...
export class MapDefnKeyContext extends ParserRuleContext {
  ...
  public COLON(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.COLON, 0);
  }
  public typeExpr(): TypeExprContext | undefined {
    return this.tryGetRuleContext(0, TypeExprContext);
  }
...
export class ExecDefnBlockContext extends ParserRuleContext {
  ...
  public execDefnBlock_item(
    i?: number
  ): ExecDefnBlock_itemContext | ExecDefnBlock_itemContext[] {
    if (i === undefined) {
...
export class ExecDeclBlockContext extends ParserRuleContext {
  ...
  public execDeclBlock_item(
    i?: number
  ): ExecDeclBlock_itemContext | ExecDeclBlock_itemContext[] {
    if (i === undefined) {
...
export class QueryDefnBlockContext extends ParserRuleContext {
  ...
  public queryDefnBlock_item(
    i?: number
  ): QueryDefnBlock_itemContext | QueryDefnBlock_itemContext[] {
    if (i === undefined) {
...
export class QueryDeclBlockContext extends ParserRuleContext {
  ...
  public queryDeclBlock_item(
    i?: number
  ): QueryDeclBlock_itemContext | QueryDeclBlock_itemContext[] {
    if (i === undefined) {
...
export class StructMemberContext extends ParserRuleContext {
  ...
  public QUEST(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.QUEST, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
...
export class TypePathContext extends ParserRuleContext {
  ...
  public D_COLON(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.D_COLON, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
...
export class FnDefnContext extends ParserRuleContext {
  ...
  public FN(): TerminalNode {
    return this.getToken(CWScriptParser.FN, 0);
  }
  public namedFnDefn(): NamedFnDefnContext {
    return this.getRuleContext(0, NamedFnDefnContext);
  }
...
export class FnTypeContext extends ParserRuleContext {
  ...
  public ARROW(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.ARROW, 0);
  }
  public typeExpr(): TypeExprContext | undefined {
    return this.tryGetRuleContext(0, TypeExprContext);
  }
...
export class NormalFnBodyContext extends FnBodyContext {
  public LBRACE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.LBRACE, 0);
  }
  public RBRACE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.RBRACE, 0);
  }
  public stmt(): StmtContext[];
...
export class ArrowFnBodyContext extends FnBodyContext {
  public FAT_ARROW(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.FAT_ARROW, 0);
  }
...
export class AssignStmt_Context extends ParserRuleContext {
  ...
  public EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EQ, 0);
  }
  public PLUS_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.PLUS_EQ, 0);
  }
  public MINUS_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MINUS_EQ, 0);
  }
  public MUL_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MUL_EQ, 0);
  }
  public DIV_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.DIV_EQ, 0);
  }
  public MOD_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MOD_EQ, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return CWScriptParser.RULE_assignStmt_;
  }
  // @Override
  public enterRule(listener: CWScriptParserListener): void {
...
export class AssignLHSContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return CWScriptParser.RULE_assignLHS;
  }
...
export class InnerAssignContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return CWScriptParser.RULE_innerAssign;
  }
  // @Override
  public enterRule(listener: CWScriptParserListener): void {
...
export class InnerPathContext extends ParserRuleContext {
  ...
  public LBRACK(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.LBRACK, 0);
  }
  public RBRACK(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.RBRACK, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return CWScriptParser.RULE_innerPath;
  }
  // @Override
  public enterRule(listener: CWScriptParserListener): void {
...
export class UnaryExprContext extends ExprContext {
  ...
  public PLUS(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.PLUS, 0);
  }
  public MINUS(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MINUS, 0);
  }
  public EXCLAM(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EXCLAM, 0);
  }
  constructor(ctx: ExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class MultDivModExprContext extends ExprContext {
  ...
  public MUL(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MUL, 0);
  }
  public DIV(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.DIV, 0);
  }
  public MOD(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MOD, 0);
  }
  constructor(ctx: ExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class CompExprContext extends ExprContext {
  ...
  public LT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.LT, 0);
  }
  public GT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.GT, 0);
  }
  public LT_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.LT_EQ, 0);
  }
  public GT_EQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.GT_EQ, 0);
  }
  constructor(ctx: ExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class EqExprContext extends ExprContext {
  ...
  public EQEQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EQEQ, 0);
  }
  public NEQ(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.NEQ, 0);
  }
  constructor(ctx: ExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class StructValMembersContext extends ParserRuleContext {
  ...
  public structValMember(
    i?: number
  ): StructValMemberContext | StructValMemberContext[] {
    if (i === undefined) {
...
export class IdentContext extends ParserRuleContext {
  public Ident(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.Ident, 0);
  }
...
export class ReservedKeywordContext extends ParserRuleContext {
  public CONTRACT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.CONTRACT, 0);
  }
  public INTERFACE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.INTERFACE, 0);
  }
  public IMPORT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.IMPORT, 0);
  }
  public IMPLEMENTS(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.IMPLEMENTS, 0);
  }
  ...
  public ERROR(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.ERROR, 0);
  }
  public EVENT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EVENT, 0);
  }
  public INSTANTIATE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.INSTANTIATE, 0);
  }
  public EXEC(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EXEC, 0);
  }
  public QUERY(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.QUERY, 0);
  }
  public MIGRATE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.MIGRATE, 0);
  }
  public FOR(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.FOR, 0);
  }
  public IN(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.IN, 0);
  }
  public FROM(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.FROM, 0);
  }
  public STATE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.STATE, 0);
  }
  public TIMES(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.TIMES, 0);
  }
  public IF(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.IF, 0);
  }
  public FN(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.FN, 0);
  }
  public ELSE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.ELSE, 0);
  }
  public AND(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.AND, 0);
  }
  public OR(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.OR, 0);
  }
  public TRUE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.TRUE, 0);
  }
  public FALSE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.FALSE, 0);
  }
  public LET(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.LET, 0);
  }
  public RETURN(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.RETURN, 0);
  }
  public STRUCT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.STRUCT, 0);
  }
  public ENUM(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.ENUM, 0);
  }
  public TYPE(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.TYPE, 0);
  }
  public EMIT(): TerminalNode | undefined {
    return this.tryGetToken(CWScriptParser.EMIT, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
